...
const galleryItems = [
    {
        ...
        span: 'lg:col-span-5 lg:row-span-2 sm:col-span-2 sm:row-span-2',
    },
    {
        ...
        span: 'lg:col-span-6 lg:row-span-2 sm:col-span-2 sm:row-span-2',
    },
     {
        ...
        span: 'lg:col-span-7 lg:row-span-2 sm:col-span-2 sm:row-span-2',
    },
    {
